...
int correction_vel=600;
 ...
 //no hago nada, pero puedo poner codigo aca si no detecta los micros
  ...
  i2c_write((spd+offset_vel) / 16);                   // Upper data bits          (D11.D10.D9.D8.D7.D6.D5.D4)
 ...
 if ((reverse_rigth != reverse_flag_rigth) && spd!=0) {
  ...
  i2c_write((spd+offset_vel) / 16);                   // Upper data bits          (D11.D10.D9.D8.D7.D6.D5.D4)  //esto sale directamente de la libreria de codigo de adafruit
  i2c_write(((spd+offset_vel) % 16) << 4);            // Lower data bits          (D3.D2.D1.D0.x.x.x.x)
  i2c_stop();
